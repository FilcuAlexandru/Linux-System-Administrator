...
#######################################################################################################################
# A Python 3.6 script that verifies Input device informations on a Linux server.                                      #
# The script verifies the following: keyboards, mice, touchpads, input devices, HID devices, and input configuration. #
# Version: 0.0.1                                                                                                      #
